    ...
    <Paper className={classes.jobTileOuter} elevation={3}>
      <Grid container>
        ...
        <Grid container item xs={7} spacing={1} direction="column">
          ...
          <Grid item>Project Details: {application.job.title}</Grid>
          <Grid item>Role: {application.job.jobType}</Grid>
          <Grid item>Applied On: {appliedOn.toLocaleDateString()}</Grid>
          <Grid item>
            Statement of Purpose: {application.sop !== "" ? application.sop : "Not Submitted"}
          </Grid>
          <Grid item>
...
const AcceptedApplicants = (props) => {
  ...
  return (
    <>
      ...
      >
        <Grid item>
          <Typography variant="h4" style={{color:'white'}}>Selected Students</Typography>
        </Grid>
        <Grid item>
